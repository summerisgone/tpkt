...
следующие работы:
  ...
  * проверка и ремонт механизмов [топок](http://www.teplokomplekt.com/topki.shtml) (питатель, цепкая решетка, мельницы, горелки и т.п.); 
  ...
  * проверка и ремонт [золоуловителей](http://www.teplokomplekt.com/cyklon.shtml) и [устройств для удаления золы](http://www.teplokomplekt.com/shlakoudalenie.shtml); 
  * наружная и внутренняя очистки поверхностен нагрева барабанов и коллекторов; 
  * проверка и ремонт [системы шлакоудаления](http://www.teplokomplekt.com/shlakoudalenie.shtml); 
...
Планирование ремонтов заключатся в разработке перспективных, годовых и
...
В соответствии с ведомостью объема работ составляется график подготовительных
...
Окончательная оценка качества ремонтных работ производится после месячной
